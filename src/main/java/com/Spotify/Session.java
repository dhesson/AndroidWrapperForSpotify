...
public class Session 
{
	...
	public void Update() 
	{
		Log.d("SpotifySession", "***** Java:Update: ");
		Update(m_nativePtr);
	}
	...
	{
		Log.d("SpotifySession", "---** Java:OnLoggedOut: ");
		//System.out.printf("JAVA - OnLoggedOut\n");
	}

	public void OnMetadataUpdated() 
	{
		Log.d("SpotifySession", "---** Java:OnMetadataUpdated: ");
	...
	{
		Log.d("SpotifySession", "---** Java:OnMusicDelivery:m_sampleType:" + format.m_sampleType + ",m_sampleRate:" + format.m_sampleRate + ",m_channels:" + format.m_channels + ",size:" + frames.length + ",numFrames" + numFrames);
	...
	{
		Log.d("SpotifySession", "---** Java:OnPlayTokenLost: ");
		//System.out.printf("Java - OnPlayTokenLost\n");
	}

	public void OnLogMessage(String message) 
	{
		Log.d("SpotifySession", "---** Java:OnLogMessage: ");
		//System.out.printf("Java - OnLogMessage [%s]\n", message);
	}

	public void OnEndOfTrack() 
	{
		Log.d("SpotifySession", "---** Java:OnEndOfTrack: ");
		...
		Log.d("SpotifySession", "---** Java:OnEndOfTrack:end ");
	}

	public void OnStreamingError(int error) 
	{
		Log.d("SpotifySession", "---** Java:OnStreamingError: ");
	}

	public void OnUserinfoUpdated() 
	{
		Log.d("SpotifySession", "---** Java:OnUserinfoUpdated: ");

	}

	public void OnStartPlayback() 
	{
		Log.d("SpotifySession", "---** Java:OnStartPlayback: ");
	}

	public void OnStopPlayback() 
	{
		Log.d("SpotifySession", "---** Java:OnStopPlayback: ");
	}

	public void OnGetAudioBufferStats(AudioBufferStats stats) 
	{
		Log.d("SpotifySession", "---** Java:OnGetAudioBufferStats: ");
